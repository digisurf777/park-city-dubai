-- Remove foreign key constraint on owner_id to allow demo listings
ALTER TABLE public.parking_listings DROP CONSTRAINT IF EXISTS parking_listings_owner_id_fkey;

-- Allow NULL owner_id for demo listings
ALTER TABLE public.parking_listings ALTER COLUMN owner_id DROP NOT NULL;
...
-- Using NULL owner_id for demo listings
(
    NULL,
