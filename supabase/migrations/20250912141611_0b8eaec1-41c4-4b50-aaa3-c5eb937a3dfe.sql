...
DROP FUNCTION IF EXISTS public.create_parking_spaces_for_listing(uuid, integer, text);
...
BEGIN
  ...
  -- Create spaces (now using p_listing_id parameter name to avoid ambiguity)
