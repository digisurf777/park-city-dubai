-- Update admin_delete_parking_listing_complete to send delisting notification to owner
...
BEGIN
  ...
  DELETE FROM public.parking_spaces WHERE listing_id = deleted_record.id;

  -- Delete related records
  DELETE FROM public.driver_owner_messages 
  WHERE listing_id = deleted_record.id;
