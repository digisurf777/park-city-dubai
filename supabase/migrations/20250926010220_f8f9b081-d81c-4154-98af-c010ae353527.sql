-- Fix unread message counting in get_owner_active_bookings function
...
BEGIN
  ...
  -- Count unread messages from driver with improved logic
  LEFT JOIN (
    SELECT 
      dom.booking_id,
    ...
    -- Remove the owner_id filter and let the booking matching handle access control
