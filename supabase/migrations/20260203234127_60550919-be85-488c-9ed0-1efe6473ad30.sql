-- Fix remaining functions with incorrect search_path settings

-- Fix check_booking_conflicts - remove pg_temp from search_path
...
-- Fix create_admin_booking_notification trigger
...
-- Fix create_user_booking_notification trigger
...
-- Fix get_admin_booking_stats function
...
-- Fix initialize_chat_on_booking_approval trigger
