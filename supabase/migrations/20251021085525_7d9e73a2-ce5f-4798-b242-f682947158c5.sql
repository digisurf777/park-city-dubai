-- Update get_unified_customer_payment_history to include chat participants
...
BEGIN
  ...
  WITH driver_stats AS (
    ...
    -- Include approved bookings (which allow chat) plus confirmed/completed
  ...
  SELECT 
    ...
    COALESCE(p.email, au_auth.email, 'no-email@example.com')::text AS email,
