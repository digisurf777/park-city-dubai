-- Refine get_unified_customer_payment_history to count only truly active transactions
...
BEGIN
  ...
  WITH driver_stats AS (
    ...
    -- Only bookings that actually happened/are confirmed (exclude merely approved)
