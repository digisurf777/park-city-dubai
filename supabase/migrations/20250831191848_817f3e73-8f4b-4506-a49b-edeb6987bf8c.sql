-- Phase 1: Fix Critical Database Issues for Authentication

-- 1. Fix UUID casting issues in existing functions
...
-- 2. Drop conflicting RLS policies on profiles table
...
-- 3. Create simple, working RLS policies for profiles table
...
-- 4. Fix handle_new_user trigger to avoid UUID casting issues
...
-- 5. Update system settings for reasonable OTP expiry
...
-- 6. Ensure trigger exists and is properly configured
