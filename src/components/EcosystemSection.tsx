  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/45 backdrop-blur-md ring-1 ring-white/30 text-primary-glow text-xs font-bold tracking-[0.2em] uppercase mb-4 shadow-[0_4px_16px_-4px_rgb(0_0_0/0.6)] drop-shadow-[0_2px_6px_rgb(0_0_0/0.6)]">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="bg-gradient-to-r from-primary-glow via-white to-primary-glow bg-clip-text text-transparent hover:underline underline-offset-4 [text-shadow:none] drop-shadow-[0_2px_8px_rgb(0_0_0/0.5)]"
            >
              Shazam
            </a>{" "}
