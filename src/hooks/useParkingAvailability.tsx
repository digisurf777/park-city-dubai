    ...
    try {
      ...
      const transformedData = filteredData.map((spot: any) => {
        ...
        return {
          ...
          image: spot.images && spot.images.length > 0 ? spot.images[0] : "/lovable-uploads/df8d1c6e-af94-4aa0-953c-34a15faf930f.webp",
          images: spot.images || [],
      ...
      const demoData: ParkingSpotWithAvailability[] = [
        {
          ...
          price: 850,
          image: "/lovable-uploads/df8d1c6e-af94-4aa0-953c-34a15faf930f.webp",
          images: ["/lovable-uploads/df8d1c6e-af94-4aa0-953c-34a15faf930f.webp"],
