                  ...
                  <AccordionTrigger className="text-left hover:no-underline py-6">
                    ...
                    <AccordionContent className="pb-6">
                      {item.question === "⭐️ Can I leave a review?" ? <p className="text-muted-foreground leading-relaxed">
                          ...
                          <a href="https://www.trustpilot.com/evaluate/shazam.ae" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                            Trustpilot
                          </a>
                          {" "}and{" "}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://www.trustpilot.com/evaluate/shazam.ae" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-primary text-primary-foreground px-6 py-3 rounded-lg hover:bg-primary/90 transition-colors font-medium shadow-lg">
