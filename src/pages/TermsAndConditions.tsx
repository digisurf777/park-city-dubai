        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8 text-foreground">
              ...
              <section>
                ...
                <div className="ml-6 mb-4">
                  ...
                  <div className="ml-6">
                    ...
                    <p className="mb-4">ii. If your Booking requires an access card or other access device to be provided to the Driver, a refundable access card/device fee (the "<strong>Refundable Access Charge</strong>") will ordinarily be collected from the Driver at the time of Booking. However, ShazamParking may, at its sole discretion, elect not to collect the Refundable Access Charge from the Driver and may instead undertake responsibility for such amount on behalf of the Driver. In all cases, the non-refundable access card handling fee (the "<strong>Handling Fee</strong>") shall remain payable to ShazamParking for the administrative services associated with managing the access device deposit and/or collecting the same from the Driver. Where ShazamParking has undertaken responsibility for the Refundable Access Charge, the Driver shall remain fully liable to ShazamParking for any loss of, or damage to, the access card/device and for any amounts that would otherwise have been deducted from the Refundable Access Charge had it been collected. ShazamParking may recover such amounts directly from the Driver at any time, including after the end of the Booking Period.</p>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">12. Driver Agreement</h2>
                <h3 className="text-xl font-semibold mb-3">1. These Terms</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2. Registration</h3>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  2.3 Booking confirmations and other relevant information in relation to the Services will be sent to the email address you give us and in your Account on the Site ("<strong>Booking Confirmation</strong>").
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  3.2 By entering into this Agreement, you gain access to Parking Spaces listed by independent Owners via our platform for temporary use during the applicable booking period ("<strong>Booking Period</strong>"), subject to the terms and conditions of this Agreement.
                </p>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">4. Bookings, and Payment</h3>
                <p className="mb-4"><strong>4.1 General Process</strong></p>
                <p className="mb-4">To request a Parking Space listed on the Site, you must submit a booking request by selecting your required dates and providing valid payment details (the "<strong>Booking Request</strong>").</p>
                <p className="mb-4">Upon submission of a Booking Request, we will, at our sole discretion, either immediately charge your payment method or place a pre-authorisation hold for the applicable booking amount.</p>
                <p className="mb-4">Within 48 hours of the Booking Request, we will confirm the availability of the Parking Space with the Owner. If the space is available, we will proceed as follows:</p>
                <div className="ml-6 mb-4">
                  <p className="mb-2">if a pre-authorisation hold was placed, the corresponding amount will be charged at that time; or</p>
                  <p className="mb-2">if payment was already processed, no further action is needed.</p>
                </div>
                ...
                <p className="mb-4">
                  6.3 You agree that if we determine that you should make further payment(s), you will be responsible for these amounts and we may use our funds in order to settle a dispute and then deduct such funds from you as a reimbursement from you. You agree that our findings on any dispute between you and the Owner are final and that you will abide by any ruling made by us in this respect.
                </p>
                <p className="mb-4">
                  6.4 You agree that the provisions in this clause will survive any termination of this Agreement.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">7. Cancellation and Termination</h3>
                <p className="mb-4">
                  7.1 If you want to cancel a Booking you must do so through the Cancellation Policy.
                </p>
                <p className="mb-4">
                ...
                <div className="ml-6 mb-4">
                  <p className="mb-2">(a) agree to observe and act in accordance with this Agreement;</p>
                  <p className="mb-2">(b) will not use the Parking Space or deal with the Owner in any way which could be deemed to be harmful to our business or reputation;</p>
                  <p className="mb-2">(c) will not attempt to book any Parking Space advertised on our Site other than through the booking procedure described in clause 4;</p>
                  <p className="mb-2">(d) will provide us with accurate information and ensure that all details that we hold about you (including your email address) are up to date and valid; and</p>
                  <p className="mb-2">(e) where applicable, only provide us with credit or debit card details for an account which is yours and which you are authorised to use to make payments.</p>
                </div>
                <p className="mb-4">
                ...
                <div className="ml-6 mb-4">
                  <p className="mb-2">(a) keep the Parking Space clean, tidy and clear of rubbish and leave the Parking Space in the same condition as you find it;</p>
                  <p className="mb-2">(b) park the vehicle in the Parking Space without obstructing any adjoining or nearby parking spaces or property;</p>
                  <p className="mb-2">(c) notify the Owner and us of any damage to the Parking Space during the Booking Period as soon as it occurs;</p>
                  <p className="mb-2">(d) not do or permit to be done on the Parking Space anything which is or which may be or become a nuisance, (whether actionable or not) damage, annoyance, inconvenience or disturbance to the Owner or to the owner or occupier of neighbouring property;</p>
                  <p className="mb-2">(e) not conduct any illegal or immoral activity from the Parking Space;</p>
                  <p className="mb-2">(f) not conduct any business or commercial activity whatsoever from the Parking Space; and</p>
                  <p className="mb-2">(g) not use the Parking Space for any purpose other than for parking in accordance with this Agreement.</p>
                </div>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">9. Termination and suspension</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">10. Our liability to you under this Agreement</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">11. Electric vehicle charging</h3>
                <p className="mb-4">
                ...
                <div className="ml-6 mb-4">
                  <p className="mb-2">(a) you have all necessary connector cables to enable your vehicle to be charged at a charge point;</p>
                  <p className="mb-2">(b) the connector cable must be safely plugged into your vehicle and the positioning of the connector cable must not create a tripping hazard to any person; and</p>
                  <p className="mb-2">(c) the connector cable must not be unplugged from the vehicle before the plug is removed from the charge point; and the vehicle must not be driven with the connector cable still attached to the charge point.</p>
                </div>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12. General</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">13. Confidentiality</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">14. Governing Law and Jurisdiction</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">13. Standard Payment Terms</h2>
                <p className="mb-4">
                  (Standalone Terms Governing Invoiced Services Rendered by Shazam Technology Solutions – FZCO)
                </p>
                <p className="mb-4">
                  These standard payment terms ("<strong>Standard Payment Terms</strong>") apply to any individual, entity or corporate party (the "<strong>you</strong>") to whom Shazam Technology Solutions – FZCO (the "<strong>us</strong>" or "<strong>we</strong>") has rendered services and issued an invoice - and to whom no other written terms of service apply, specifically excluding any payment made directly through the ShazamParking.ae website ("<strong>Site</strong>"). Subject to the foregoing, these Standard Payment Terms shall operate as an independent and self-contained set of contractual provisions and shall be incorporated by reference into any service transaction or invoice issued by us to a you.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">1. Scope and Binding Nature</h3>
                <p className="mb-4">
                  1.1 These Standard Payment Terms govern all invoiced engagements where we have delivered, performed, or facilitated any form of service or deliverable to you, and to whom no other written terms of service apply, specifically excluding any payment made directly through the Site.
                </p>
                <p className="mb-4">
                  1.2 By receiving or accepting any service deliverable and/or invoice from us, excluding any service provided under separate written terms or payment made directly through the Site, you acknowledge and agree that these Standard Payment Terms shall be binding and enforceable in full.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">2. Invoice and Payment Terms</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">3. Late Payment and Consequences</h3>
                <p className="mb-4">
                ...
                <div className="ml-6 mb-4">
                  <p className="mb-2">(a) apply a late payment fee of AED 200 per calendar week (or part thereof) of delay;</p>
                  <p className="mb-2">(b) suspend the provision of any further services or Site access until payment is received;</p>
                  <p className="mb-2">(c) terminate any active or pending service arrangements with the Client;</p>
                  <p className="mb-2">(d) withhold deliverables, data access, or documentation otherwise due to you; and</p>
                  <p className="mb-2">(e) report the non-payment to appropriate credit or industry reporting databases, where applicable.</p>
                </div>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">4. Invoice Disputes</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">5. No Right of Set-Off</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">6. Costs of Recovery</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7. Governing Law and Dispute Resolution</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">Annexure A - Cancellation Policy</h2>
                
                <h3 className="text-xl font-semibold mb-3">1. Binding Nature of Bookings</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3">2. Driver Cancellations – Strict No Refund Policy</h3>
                <p className="mb-4">
                  Drivers may not cancel a booking once payment is made.
                </p>
                <p className="mb-4">
                ...
                <div className="ml-6 mb-4">
                  <p className="mb-2"><strong>Access Failure</strong> – e.g. blocked space, faulty or missing access card;</p>
                  <p className="mb-2"><strong>Third-Party Intervention</strong> – e.g. landlord, strata, or regulatory authority prevents use;</p>
                  <p className="mb-2"><strong>Force Majeure</strong> – including, but not limited to, acts of God, war, fire, flood, pandemic, or government orders, as recognized under UAE Civil Code; or</p>
                  <p className="mb-2"><strong>Serious Owner Misconduct</strong> – e.g. fraudulent listing, breach of lease, untruthful details</p>
                </div>
                <p className="mb-4">
                  All claims must be made within 48 hours of the incident, by email, with supporting evidence.
                </p>

                <h3 className="text-xl font-semibold mb-3">4. Owner Cancellations</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3">5. Refund Processing and Deductions</h3>
                <p className="mb-4">
                  All approved refunds will be processed within 20 business days
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  Any fraudulent, abusive, or misleading conduct by a Driver or Owner will result in account suspension and potential legal action.
                </p>
                <p className="mb-4">
                  No refunds are given to Drivers who "no-show" or do not use the Parking Space for the entirety of the Booking Period.
                </p>

                <h3 className="text-xl font-semibold mb-3">7. Final Authority</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3">8. Owner Liability for Commission in Cases of Misconduct or Listing Failures</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">Annexure B - Referral Program</h2>
                <p className="mb-4">
                  We may, from time to time, operate a Driver Referral Program and an Owner Referral Program (each a "<strong>Referral Program</strong>") to reward eligible Drivers and Owners for introducing new Drivers and/or new Owners to the Site.
                </p>

                <h3 className="text-xl font-semibold mb-3">(a) Driver Referral</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3">(b) Owner Referral</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3">(c) Eligibility and Conditions</h3>
                <div className="ml-6 mb-4">
                  <p className="mb-4">(i) The referred Driver or Owner must not already have (or have had in 2-year period preceding the referral) an account on the Site.</p>
                  <p className="mb-4">(ii) Any referral must be made through the Site's official referral link or code system, if available, or otherwise in accordance with the instructions provided by us.</p>
                  <p className="mb-4">(iii) Referral rewards shall not be available if we, acting reasonably, determine that the referral was self-created, fraudulent, or in breach of these terms.</p>
                  <p className="mb-4">(iv) We reserve the right to cancel, suspend or modify any Referral Program at any time, in whole or in part, without prior notice.</p>
                  <p className="mb-4">(v) Referral rewards are non-transferable, have no cash value unless otherwise stated, and may be used only in accordance with the Site's policies.</p>
                  <p className="mb-4">(vi) Our decision regarding eligibility, calculation of rewards and any related disputes shall be final and binding.</p>
                  <p className="mb-4">(vii) Owners and Drivers may not circumvent the Site's payment processes or booking rules by misusing the Referral Program. Any such conduct shall be treated as a material breach and may result in suspension, termination or forfeiture of any accrued referral rewards.</p>
                </div>
              </section>
