        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Rent your parking space in just 3 simple steps
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">1. Add Your Space</h3>
              <p className="text-gray-600">
                Fill in address, price, access type.
              </p>
              <img 
                src={phoneLogo} 
                alt="Step 1"
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">2. Approve Bookings</h3>
              <p className="text-gray-600">
                You accept or reject each request.
              </p>
              <img 
                src={phoneLogo} 
                alt="Step 2"
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">3. Get Paid Monthly</h3>
              <p className="text-gray-600">
