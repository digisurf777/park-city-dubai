...
const DubaiMarina = () => {
  ...
  const { parkingSpots, loading, error } = useParkingAvailability("Dubai Marina");
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-white px-4 max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold bg-black/20 inline-block px-3 py-2 sm:px-4 rounded-lg">
              Secure a monthly parking bay from AED600
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Filter Bar */}
      <div className="sticky top-20 z-40 bg-white border-b shadow-sm"></div>
